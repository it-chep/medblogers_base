...
import (
	...
	"medblogers_base/internal/modules/admin/entities/doctors/action/doctor/deactivate/dal"
...
type Subscribers interface {
	DeactivateDoctor(ctx context.Context, doctorID int64) error
}
...
func (a *Action) Do(ctx context.Context, doctorID int64) error {
	...
	if !doc.GetIsActive() {
		return errors.New("Доктор уже деактивирован")
	}

	err = a.subscribers.DeactivateDoctor(ctx, doctorID)
	if err != nil {
		return err
	}
