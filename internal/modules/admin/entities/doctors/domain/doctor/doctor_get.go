...
// GetCooperationType получение типа размещения доктора
func (d *Doctor) GetCooperationType() CooperationType {
	return d.cooperationType
}

// GetBirthDate получение даты рождения
func (d *Doctor) GetBirthDate() time.Time {
	return d.birthDate
}

// GetCreatedAt получение даты создания
