...
import (
	...
	actionDal "medblogers_base/internal/modules/admin/entities/promo_offers/action/brand/deactivate/dal"
...
type ActionDal interface {
	DeactivateBrand(ctx context.Context, brandID int64) error
}
...
func (a *Action) Do(ctx context.Context, brandID int64) error {
	...
	if !item.GetIsActive() {
		return errors.New("Бренд уже неактивен")
	}

	return a.actionDal.DeactivateBrand(ctx, brandID)
}
