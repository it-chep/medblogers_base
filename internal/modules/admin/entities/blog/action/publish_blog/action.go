...
import (
	"context"
	"medblogers_base/internal/modules/admin/entities/blog/action/publish_blog/dal"
	"medblogers_base/internal/modules/admin/entities/blog/action/publish_blog/dto"
	"medblogers_base/internal/modules/admin/entities/blog/action/publish_blog/rules"
...
func (a *Action) Do(ctx context.Context, blogID uuid.UUID, primaryImageUUID *uuid.UUID) error {
	...
	err = a.dal.UnMarkBlogImagesIsPrimary(ctx, blogID)
	if err != nil {
		return err
	}
