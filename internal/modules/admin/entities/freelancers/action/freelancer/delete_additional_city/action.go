...
import (
	"context"
	"medblogers_base/internal/modules/admin/entities/freelancers/action/freelancer/delete_additional_city/dal"
...
type ActionDal interface {
	DeleteAdditionalCity(ctx context.Context, freelancerID, cityID int64) error
}
...
func (a *Action) Do(ctx context.Context, freelancerID, cityID int64) error {
	...
	return a.actionDal.DeleteAdditionalCity(ctx, freelancerID, cityID)
}
