...
import (
	"context"
	"medblogers_base/internal/modules/admin/entities/freelancers/action/freelancer/delete_network/dal"
...
type ActionDal interface {
	DeleteNetwork(ctx context.Context, freelancerID, networkID int64) error
}
...
func (a *Action) Do(ctx context.Context, freelancerID, networkID int64) error {
	...
	return a.actionDal.DeleteNetwork(ctx, freelancerID, networkID)
}
