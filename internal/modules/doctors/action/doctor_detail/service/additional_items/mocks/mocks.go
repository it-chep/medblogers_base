...
func (m *MockStorage) GetDoctorAdditionalCities(arg0 context.Context, arg1 doctor.MedblogersID) ([]*city.City, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) GetDoctorAdditionalSpecialities(arg0 context.Context, arg1 doctor.MedblogersID) ([]*speciality.Speciality, error) {
	m.ctrl.T.Helper()
