...
var file_doctors_v1_doctors_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_doctors_v1_doctors_proto_goTypes = []any{
	...
	(*GetSettingsResponse_FilterItem)(nil),          // 25: doctor.v1.GetSettingsResponse.FilterItem
	(*GetSettingsResponse_CityItem)(nil),            // 26: doctor.v1.GetSettingsResponse.CityItem
	(*GetSettingsResponse_SpecialityItem)(nil),      // 27: doctor.v1.GetSettingsResponse.SpecialityItem
	(*CitiesResponse_CityItem)(nil),                 // 28: doctor.v1.CitiesResponse.CityItem
	(*SpecialitiesResponse_SpecialityItem)(nil),     // 29: doctor.v1.SpecialitiesResponse.SpecialityItem
	(*MainSpecialitiesResponse_SpecialityItem)(nil), // 30: doctor.v1.MainSpecialitiesResponse.SpecialityItem
	(*SearchResponse_DoctorItem)(nil),               // 31: doctor.v1.SearchResponse.DoctorItem
	(*SearchResponse_CityItem)(nil),                 // 32: doctor.v1.SearchResponse.CityItem
	(*SearchResponse_SpecialityItem)(nil),           // 33: doctor.v1.SearchResponse.SpecialityItem
	(*FilterResponse_DoctorItem)(nil),               // 34: doctor.v1.FilterResponse.DoctorItem
	(*CreateDoctorResponse_ValidationError)(nil),    // 35: doctor.v1.CreateDoctorResponse.ValidationError
	(*GetDoctorResponse_CityItem)(nil),              // 36: doctor.v1.GetDoctorResponse.CityItem
	(*GetDoctorResponse_SpecialityItem)(nil),        // 37: doctor.v1.GetDoctorResponse.SpecialityItem
}
var file_doctors_v1_doctors_proto_depIdxs = []int32{
	25, // 0: doctor.v1.GetSettingsResponse.filter_info:type_name -> doctor.v1.GetSettingsResponse.FilterItem
	26, // 1: doctor.v1.GetSettingsResponse.cities:type_name -> doctor.v1.GetSettingsResponse.CityItem
	27, // 2: doctor.v1.GetSettingsResponse.specialities:type_name -> doctor.v1.GetSettingsResponse.SpecialityItem
	28, // 3: doctor.v1.CitiesResponse.cities:type_name -> doctor.v1.CitiesResponse.CityItem
	29, // 4: doctor.v1.SpecialitiesResponse.specialities:type_name -> doctor.v1.SpecialitiesResponse.SpecialityItem
	30, // 5: doctor.v1.MainSpecialitiesResponse.specialities:type_name -> doctor.v1.MainSpecialitiesResponse.SpecialityItem
	31, // 6: doctor.v1.SearchResponse.doctors:type_name -> doctor.v1.SearchResponse.DoctorItem
	32, // 7: doctor.v1.SearchResponse.cities:type_name -> doctor.v1.SearchResponse.CityItem
	33, // 8: doctor.v1.SearchResponse.specialities:type_name -> doctor.v1.SearchResponse.SpecialityItem
	0,  // 9: doctor.v1.FilterRequest.sort:type_name -> doctor.v1.FilterRequest.Sort
	34, // 10: doctor.v1.FilterResponse.doctors:type_name -> doctor.v1.FilterResponse.DoctorItem
	35, // 11: doctor.v1.CreateDoctorResponse.errors:type_name -> doctor.v1.CreateDoctorResponse.ValidationError
	36, // 12: doctor.v1.GetDoctorResponse.cities:type_name -> doctor.v1.GetDoctorResponse.CityItem
	37, // 13: doctor.v1.GetDoctorResponse.specialities:type_name -> doctor.v1.GetDoctorResponse.SpecialityItem
	36, // 14: doctor.v1.GetDoctorResponse.main_city:type_name -> doctor.v1.GetDoctorResponse.CityItem
	37, // 15: doctor.v1.GetDoctorResponse.main_speciality:type_name -> doctor.v1.GetDoctorResponse.SpecialityItem
	...
	4,  // 29: doctor.v1.DoctorService.GetSettings:output_type -> doctor.v1.GetSettingsResponse
	6,  // 30: doctor.v1.DoctorService.GetCounters:output_type -> doctor.v1.GetCountersResponse
	22, // 31: doctor.v1.DoctorService.GetPreliminaryFilterCount:output_type -> doctor.v1.PreliminaryFilterCountResponse
	24, // 32: doctor.v1.DoctorService.GetPagesCount:output_type -> doctor.v1.PagesCountResponse
	8,  // 33: doctor.v1.DoctorService.GetCities:output_type -> doctor.v1.CitiesResponse
	10, // 34: doctor.v1.DoctorService.GetSpecialities:output_type -> doctor.v1.SpecialitiesResponse
	12, // 35: doctor.v1.DoctorService.GetSMainSpecialities:output_type -> doctor.v1.MainSpecialitiesResponse
	14, // 36: doctor.v1.DoctorService.Search:output_type -> doctor.v1.SearchResponse
	16, // 37: doctor.v1.DoctorService.Filter:output_type -> doctor.v1.FilterResponse
	18, // 38: doctor.v1.DoctorService.CreateDoctor:output_type -> doctor.v1.CreateDoctorResponse
	20, // 39: doctor.v1.DoctorService.GetDoctor:output_type -> doctor.v1.GetDoctorResponse
