...
const file_admin_blogs_v1_admin_proto_rawDesc = "" +
	...
	"\ablog_id\x18\x01 \x01(\tR\x06blogId\"\xae\x02\n" +
	...
	"\x0fsociety_preview\x18\a \x01(\tR\x0esocietyPreview\x12.\n" +
	"\x13additional_seo_text\x18\b \x01(\tR\x11additionalSeoText\x12'\n" +
	"\x0fordering_number\x18\t \x01(\x03R\x0eorderingNumber\"\x19\n" +
	...
	"\x0fValidationError\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x12\n" +
	"\x04text\x18\x02 \x01(\tR\x04text2\x9c\f\n" +
	"\x11BlogsAdminService\x12\x9a\x01\n" +
	...
	"\rUnPublishBlog\x12$.admin.blogs.v1.UnPublishBlogRequest\x1a%.admin.blogs.v1.UnPublishBlogResponse\"g\x92A3\x121Снятие статьи с публикации\x82\xd3\xe4\x93\x02+:\x01*\"&/api/v1/admin/blog/{blog_id}/unpublishB\x14Z\x12api/admin/blogs/v1b\x06proto3"
...
var file_admin_blogs_v1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_admin_blogs_v1_admin_proto_goTypes = []any{
	...
	(*GetBlogsResponse_Blog)(nil),                 // 16: admin.blogs.v1.GetBlogsResponse.Blog
	(*SaveBlogImageResponse_Image)(nil),           // 17: admin.blogs.v1.SaveBlogImageResponse.Image
	(*PublishBlogResponse_ValidationError)(nil),   // 18: admin.blogs.v1.PublishBlogResponse.ValidationError
	(*UnPublishBlogResponse_ValidationError)(nil), // 19: admin.blogs.v1.UnPublishBlogResponse.ValidationError
}
var file_admin_blogs_v1_admin_proto_depIdxs = []int32{
	16, // 0: admin.blogs.v1.GetBlogsResponse.blogs:type_name -> admin.blogs.v1.GetBlogsResponse.Blog
	17, // 1: admin.blogs.v1.SaveBlogImageResponse.image:type_name -> admin.blogs.v1.SaveBlogImageResponse.Image
	18, // 2: admin.blogs.v1.PublishBlogResponse.errors:type_name -> admin.blogs.v1.PublishBlogResponse.ValidationError
	19, // 3: admin.blogs.v1.UnPublishBlogResponse.errors:type_name -> admin.blogs.v1.UnPublishBlogResponse.ValidationError
	0,  // 4: admin.blogs.v1.BlogsAdminService.GetBlogs:input_type -> admin.blogs.v1.GetBlogsRequest
	2,  // 5: admin.blogs.v1.BlogsAdminService.GetBlogByID:input_type -> admin.blogs.v1.GetBlogByIDRequest
	4,  // 6: admin.blogs.v1.BlogsAdminService.CreateDraftBlog:input_type -> admin.blogs.v1.CreateDraftBlogRequest
	6,  // 7: admin.blogs.v1.BlogsAdminService.UpdateDraftBlog:input_type -> admin.blogs.v1.UpdateDraftBlogRequest
	8,  // 8: admin.blogs.v1.BlogsAdminService.SaveBlogImage:input_type -> admin.blogs.v1.SaveBlogImageRequest
	10, // 9: admin.blogs.v1.BlogsAdminService.DeleteBlogImage:input_type -> admin.blogs.v1.DeleteBlogImageRequest
	12, // 10: admin.blogs.v1.BlogsAdminService.PublishBlog:input_type -> admin.blogs.v1.PublishBlogRequest
	14, // 11: admin.blogs.v1.BlogsAdminService.UnPublishBlog:input_type -> admin.blogs.v1.UnPublishBlogRequest
	1,  // 12: admin.blogs.v1.BlogsAdminService.GetBlogs:output_type -> admin.blogs.v1.GetBlogsResponse
	3,  // 13: admin.blogs.v1.BlogsAdminService.GetBlogByID:output_type -> admin.blogs.v1.GetBlogByIDResponse
	5,  // 14: admin.blogs.v1.BlogsAdminService.CreateDraftBlog:output_type -> admin.blogs.v1.CreateDraftBlogResponse
	7,  // 15: admin.blogs.v1.BlogsAdminService.UpdateDraftBlog:output_type -> admin.blogs.v1.UpdateDraftBlogResponse
	9,  // 16: admin.blogs.v1.BlogsAdminService.SaveBlogImage:output_type -> admin.blogs.v1.SaveBlogImageResponse
	11, // 17: admin.blogs.v1.BlogsAdminService.DeleteBlogImage:output_type -> admin.blogs.v1.DeleteBlogImageResponse
	13, // 18: admin.blogs.v1.BlogsAdminService.PublishBlog:output_type -> admin.blogs.v1.PublishBlogResponse
	15, // 19: admin.blogs.v1.BlogsAdminService.UnPublishBlog:output_type -> admin.blogs.v1.UnPublishBlogResponse
